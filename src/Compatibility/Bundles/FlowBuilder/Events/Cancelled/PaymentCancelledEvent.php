...
namespace Kiener\MolliePayments\Compatibility\Bundles\FlowBuilder\Events\Cancelled;
...
class PaymentCancelledEvent extends Event implements OrderAware, MailAware, SalesChannelAware, BusinessEventInterface
{
    ...
    {
        return 'mollie.payment.cancelled';
    }
